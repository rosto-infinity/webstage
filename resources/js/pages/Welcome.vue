...
<template>
  ...
  <div class="min-h-screen bg-gradient-to-b from-green-50 to-white">
    ...
    <section class="welcome-section relative overflow-hidden">
      <div class="absolute inset-0 z-0 bg-green-50/80 backdrop-blur-sm"></div>
      
      <div class="relative z-10 max-w-7xl mx-auto px-6 py-24 sm:py-32 lg:px-8">
        <div class="parallax-layer" data-depth="0.2">
          <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-green-900 mb-6">
            Bienvenue chez <span class="text-green-600">Web Stage</span>
          </h1>
        </div>

        <div class="animate__animated animate__fadeIn animate__delay-1s">
          <p class="text-lg md:text-xl text-green-700 max-w-3xl leading-relaxed">
        ...
        <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2">
          <div class="mouse-scroll animate-bounce">
            <div class="mouse-wheel bg-green-600"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="stats-section py-20 bg-white/80 backdrop-blur-sm">
...
<style scoped>
/* Effets de particules adaptés au thème vert */
.particles {
  position: absolute;
  width: 100%;
  height: 100%;
  background-image: radial-gradient(circle at 20% 50%, rgba(34, 197, 94, 0.1) 1px, transparent 1px);
...
.cta-primary:hover {
  ...
  background: linear-gradient(45deg, #15803d 0%, #16a34a 100%);
}
